...
// Lucide icon imports
import { Truck, ArrowRight, X } from 'lucide-vue-next'; // <-- 1. Import the 'X' icon
...
<template>
  <div class="grid lg:grid-cols-4 min-h-screen bg-gray-900 text-white overflow-hidden">
    ...
    <Transition name="slide-fade">
      <div v-if="showLogin" class="flex items-center justify-center bg-gray-100 text-black p-8">
        <Card class="w-full max-w-sm border-none shadow-lg bg-white relative">
          ...
          <CardHeader>
            <CardTitle class="text-2xl text-center">Account Login</CardTitle>
